...
\author{J. Raimbault$^{1,2,3,\ast}$, N. Zdanowska$^{1,3}$\smallskip\\
$^{1}$ Centre for Advanced Spatial Analysis, UCL\\
...
\begin{figure}
	\begin{center}
    \includegraphics[width=0.5\textwidth]{figures/pareto_colorgammaOrigin.png}
    \end{center}
