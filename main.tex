...
%(which is different than renormalising the probability), 
...
%Besides model dynamics, its initialisation (or parametrisation on real data) regarding the spatial distribution, sizes and industrial sector compositions, it remains important to understand the model behavior. 
...
% I believe than something on the results of the COVID/lockdown scenario should be commented in the discussion as well 
