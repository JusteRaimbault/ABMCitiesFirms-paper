...
%1.1 -
	...
	$\rightarrow$ \todo{(All) Rewrite lit review. Include applications of gravity models to trade and migration.}
...
%1.2 - 
	...
	$\rightarrow$ \todo{(JR) Discuss choice/possibly test other stat models}
...
%1.3 -
	...
	$\rightarrow$ \todo{(JR) total time is linked to $w_0$ - discuss this}
...
%2.1 -
	...
	$\rightarrow$ \todo{(All) discuss possible extension with self-connex}
...
% 2.2 - 
	...
	$\rightarrow$ \todo{(NZ) The choice of indicators has been better justified and explained based on citations of previous literature, already using these indicators to capture important globalisation processes in a city level network}
...
%2.4
	...
	$\rightarrow$ \todo{(JR) other stat models (see above)}
