...
\begin{itemize}
    ...
    \item World city network driven by interactions between firms (Taylor, 2001; Martinus and Sigler, 2018)
...
\begin{itemize}
    ...
    \item Adaptive cycles and diffusion on innovation (H{\"a}gerstrand, 1973) 
    \item Path dependence \cite{martinsunley2006information}
